    ...
    <div className='register'>
        <div className='register_content'>
            <form className='register_content_form'onSubmit={handleSubmit}>
               ...
               <input placeholder="Last Name" name="lasttname" value={formData.lasttname}  onChange={handleChange}  required /> 
               ...
               required  /> 
               <label htmlFor="image"><img src="/assets/addImage.png" alt="add profile photo" />
